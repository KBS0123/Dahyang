...
<div class="page">
        <div class="content">
	        ...
	        <div class="like-button-page">
	        	<c:choose>
			        <c:when test="${isLiked}">
			            <button id="likeButton" class="liked" data-fid="${feed.fid}" data-clid="${clid}" data-uid="${user.uid}">
			        ...
			        <c:otherwise>
			        	<button id="likeButton" class="not-liked" data-fid="${feed.fid}" data-clid="${clid}" data-uid="${user.uid}">
			                <div class="like-wrapper">
			                    <div class="ripple"></div>
			                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24">
